...
public class SerialSocket implements SerialInputOutputManager.Listener {
    ...
    private static final int WRITE_WAIT_MILLIS = 20000; // 0 blocked infinitely on unprogrammed arduino
    ...
    void disconnect() {
        ...
        if (serialPort != null) {
            ...
            try {
                ...
                Toast.makeText(context.getApplicationContext(), ignored.toString(), Toast.LENGTH_LONG).show();
            }
            serialPort = null;
        }
        if (connection != null) {
    ...
    void write(byte[] data) throws IOException {
        ...
        //Toast.makeText(context.getApplicationContext(), "serial socket:"+data.toString(),Toast.LENGTH_LONG).show();
    }
