...
public class TerminalFragment extends Fragment implements ServiceConnection, SerialListener, AdapterView.OnItemSelectedListener {
    ...
    private int deviceId, portNum, baudRate, delay = 0;
    private UsbSerialPort usbSerialPort;
    private SerialService service;
    private TextView TVUSBStatus, receiveText, sendText;
    ...
    private boolean graphvaluesread = false;
    ...
    private boolean Allchannels = false, ch1 = false, ch2 = false, ch3 = false, ch4 = false,
            ch5 = false, ch6 = false, ch7 = false, ch8 = false, ch9 = false, ch10 = false, ch11 = false, ch12 = false,
            ch13 = false, ch14 = false, ch15 = false, ch16 = false;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            ...
            //Spinner Adapter for Axis modes
            ...
            stopgraphbutton.setEnabled(false);
            //start graph button
            startgraphbutton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startgraphbutton.setEnabled(false);
                    stopgraphbutton.setEnabled(true);
            ...
            stopgraphbutton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startgraphbutton.setEnabled(true);
                    stopgraphbutton.setEnabled(false);
            ...
            xl1.setTextColor(Color.rgb(0, 0, 0));
            ...
            xl2.setTextColor(Color.rgb(0, 0, 0));
            ...
            //This handler continously sending command to Serial Port
            ...
            //This handler Continuously plotting with serial port values
                        ...
                        if (plotData) {
                            if (Allchannels == true) {
                                if (allaxis == true) {
                                    ...
                                    addEntry();
                                } else if (plotyaxis == true) {
                                    addEntry1();
                                } else if (plotzaxis == true) {
                                    addEntry2();
                                }
                            } else if (ch1 == true) {
                                if (allaxis == true) {
                                ...
                                Toast.makeText(getActivity(), "Ch10true", Toast.LENGTH_LONG).show();
                                if (allaxis == true) {
                                    EntryXaxisChannel10();
                                    EntryYaxisChannel10();
                                    EntryZaxisChannel10();
                                } else if (plotxaxis == true) {
                                    Toast.makeText(getActivity(), "Ch10true1", Toast.LENGTH_LONG).show();
                                    EntryXaxisChannel10();
                                } else if (plotyaxis == true) {
                                    EntryYaxisChannel10();
                                } else if (plotzaxis == true) {
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        try {
            ...
            //Spinner for Channels Selection
            if (item.equals("All channels")) {
                Allchannels = true;
                ch1 = false;
                ch2 = false;
                ch3 = false;
            ...
            //Spinner for Axis Mode selection
    ...
    //This is the Dataseries for Ploting the graph

    //For Multiple channels and multiple Axis
    ...
    //Single channel and single Axis
    //Channel1
    private void EntryXaxisChannel1() {
        try {
            ...
            if (data1 != null) {
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch1Xaxis), 0);
                data1.notifyDataChanged();
                mChart1.notifyDataSetChanged();
                mChart1.setVisibleXRangeMaximum(100);
    ...
    private void EntryYaxisChannel1() {
        try {
            LineData data1 = mChart2.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch1Yaxis), 0);
                data1.notifyDataChanged();
                mChart2.notifyDataSetChanged();
                mChart2.setVisibleXRangeMaximum(100);
                mChart2.moveViewToX(data1.getEntryCount());
    ...
    private void EntryZaxisChannel1() {
        try {
            LineData data1 = mChart3.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                if (set1 == null) {
                    set1 = createSet1();
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch1Zaxis), 0);
                data1.notifyDataChanged();
                mChart3.notifyDataSetChanged();
                mChart3.setVisibleXRangeMaximum(100);
                mChart3.moveViewToX(data1.getEntryCount());
    ...
    //Channel2
    private void EntryXaxisChannel2() {
        try {
            LineData data1 = mChart1.getData();
            if (data1 != null) {
                ...
                data1.addEntry(new Entry(set2.getEntryCount(), ch2Xaxis), 0);
                data1.notifyDataChanged();
                mChart1.notifyDataSetChanged();
                mChart1.setVisibleXRangeMaximum(100);
                mChart1.moveViewToX(data1.getEntryCount());
    ...
    private void EntryYaxisChannel2() {
        try {
            LineData data1 = mChart2.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch2Yaxis), 0);
                data1.notifyDataChanged();
                mChart2.notifyDataSetChanged();
                mChart2.setVisibleXRangeMaximum(100);
                mChart2.moveViewToX(data1.getEntryCount());
    ...
    private void EntryZaxisChannel2() {
        try {
            LineData data1 = mChart3.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch2Zaxis), 0);
                data1.notifyDataChanged();
                mChart3.notifyDataSetChanged();
                mChart3.setVisibleXRangeMaximum(100);
                mChart3.moveViewToX(data1.getEntryCount());
    ...
    //Channel3
    private void EntryXaxisChannel3() {
        try {
            LineData data1 = mChart1.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch3Xaxis), 0);
                data1.notifyDataChanged();
                mChart1.notifyDataSetChanged();
                mChart1.setVisibleXRangeMaximum(100);
                mChart1.moveViewToX(data1.getEntryCount());
    ...
    private void EntryYaxisChannel3() {
        try {
            LineData data1 = mChart2.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch3Yaxis), 0);
                data1.notifyDataChanged();
                mChart2.notifyDataSetChanged();
                mChart2.setVisibleXRangeMaximum(100);
                mChart2.moveViewToX(data1.getEntryCount());
    ...
    private void EntryZaxisChannel3() {
        try {
            LineData data1 = mChart3.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch3Zaxis), 0);
                data1.notifyDataChanged();
                mChart3.notifyDataSetChanged();
                mChart3.setVisibleXRangeMaximum(100);
                mChart3.moveViewToX(data1.getEntryCount());
    ...
    //Channel4
    private void EntryXaxisChannel4() {
        try {
            LineData data1 = mChart1.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch4Xaxis), 0);
                data1.notifyDataChanged();
                mChart1.notifyDataSetChanged();
                mChart1.setVisibleXRangeMaximum(100);
                mChart1.moveViewToX(data1.getEntryCount());
    ...
    private void EntryYaxisChannel4() {
        try {
            LineData data1 = mChart2.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch4Yaxis), 0);
                data1.notifyDataChanged();
                mChart2.notifyDataSetChanged();
                mChart2.setVisibleXRangeMaximum(100);
                mChart2.moveViewToX(data1.getEntryCount());
    ...
    private void EntryZaxisChannel4() {
        try {
            LineData data1 = mChart3.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch4Zaxis), 0);
                data1.notifyDataChanged();
                mChart3.notifyDataSetChanged();
                mChart3.setVisibleXRangeMaximum(100);
                mChart3.moveViewToX(data1.getEntryCount());
    ...
    //Channel5
    private void EntryXaxisChannel5() {
        try {
            LineData data1 = mChart1.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch5Xaxis), 0);
                data1.notifyDataChanged();
                mChart1.notifyDataSetChanged();
                mChart1.setVisibleXRangeMaximum(100);
                mChart1.moveViewToX(data1.getEntryCount());
    ...
    private void EntryYaxisChannel5() {
        try {
            LineData data1 = mChart2.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch5Yaxis), 0);
                data1.notifyDataChanged();
                mChart2.notifyDataSetChanged();
                mChart2.setVisibleXRangeMaximum(100);
                mChart2.moveViewToX(data1.getEntryCount());
    ...
    private void EntryZaxisChannel5() {
        try {
            LineData data1 = mChart3.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch5Zaxis), 0);
                data1.notifyDataChanged();
                mChart3.notifyDataSetChanged();
                mChart3.setVisibleXRangeMaximum(100);
                mChart3.moveViewToX(data1.getEntryCount());
    ...
    //Channel6
    private void EntryXaxisChannel6() {
        try {
            LineData data1 = mChart1.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch6Xaxis), 0);
                data1.notifyDataChanged();
                mChart1.notifyDataSetChanged();
                mChart1.setVisibleXRangeMaximum(100);
                mChart1.moveViewToX(data1.getEntryCount());
    ...
    private void EntryYaxisChannel6() {
        try {
            LineData data1 = mChart2.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch6Yaxis), 0);
                data1.notifyDataChanged();
                mChart2.notifyDataSetChanged();
                mChart2.setVisibleXRangeMaximum(100);
                mChart2.moveViewToX(data1.getEntryCount());
    ...
    private void EntryZaxisChannel6() {
        try {
            LineData data1 = mChart3.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch6Zaxis), 0);
                data1.notifyDataChanged();
                mChart3.notifyDataSetChanged();
                mChart3.setVisibleXRangeMaximum(100);
                mChart3.moveViewToX(data1.getEntryCount());
    ...
    //Channel7
    private void EntryXaxisChannel7() {
        try {
            LineData data1 = mChart1.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch7Xaxis), 0);
                data1.notifyDataChanged();
                mChart1.notifyDataSetChanged();
                mChart1.setVisibleXRangeMaximum(100);
                mChart1.moveViewToX(data1.getEntryCount());
    ...
    private void EntryYaxisChannel7() {
        try {
            LineData data1 = mChart2.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch7Yaxis), 0);
                data1.notifyDataChanged();
                mChart2.notifyDataSetChanged();
                mChart2.setVisibleXRangeMaximum(100);
                mChart2.moveViewToX(data1.getEntryCount());
    ...
    private void EntryZaxisChannel7() {
        try {
            LineData data1 = mChart3.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch7Zaxis), 0);
                data1.notifyDataChanged();
                mChart3.notifyDataSetChanged();
                mChart3.setVisibleXRangeMaximum(100);
                mChart3.moveViewToX(data1.getEntryCount());
    ...
    //Channel8
    private void EntryXaxisChannel8() {
        try {
            LineData data1 = mChart1.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch8Xaxis), 0);
                data1.notifyDataChanged();
                mChart1.notifyDataSetChanged();
                mChart1.setVisibleXRangeMaximum(100);
                mChart1.moveViewToX(data1.getEntryCount());
    ...
    private void EntryYaxisChannel8() {
        try {
            LineData data1 = mChart2.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch8Yaxis), 0);
                data1.notifyDataChanged();
                mChart2.notifyDataSetChanged();
                mChart2.setVisibleXRangeMaximum(100);
                mChart2.moveViewToX(data1.getEntryCount());
    ...
    private void EntryZaxisChannel8() {
        try {
            LineData data1 = mChart3.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch8Zaxis), 0);
                data1.notifyDataChanged();
                mChart3.notifyDataSetChanged();
                mChart3.setVisibleXRangeMaximum(100);
                mChart3.moveViewToX(data1.getEntryCount());
    ...
    //Channel9
    private void EntryXaxisChannel9() {
        try {
            LineData data1 = mChart1.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch9Xaxis), 0);
                data1.notifyDataChanged();
                mChart1.notifyDataSetChanged();
                mChart1.setVisibleXRangeMaximum(100);
                mChart1.moveViewToX(data1.getEntryCount());
    ...
    private void EntryYaxisChannel9() {
        try {
            LineData data1 = mChart2.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch9Yaxis), 0);
                data1.notifyDataChanged();
                mChart2.notifyDataSetChanged();
                mChart2.setVisibleXRangeMaximum(100);
                mChart2.moveViewToX(data1.getEntryCount());
    ...
    private void EntryZaxisChannel9() {
        try {
            LineData data1 = mChart3.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch9Zaxis), 0);
                data1.notifyDataChanged();
                mChart3.notifyDataSetChanged();
                mChart3.setVisibleXRangeMaximum(100);
                mChart3.moveViewToX(data1.getEntryCount());
    ...
    //Channel10
    private void EntryXaxisChannel10() {
        try {
            LineData data1 = mChart1.getData();
            if (data1 != null) {
                ILineDataSet set2 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set2.getEntryCount(), ch10Xaxis), 0);
                data1.notifyDataChanged();
                mChart1.notifyDataSetChanged();
                mChart1.setVisibleXRangeMaximum(100);
                mChart1.moveViewToX(data1.getEntryCount());
    ...
    private void EntryYaxisChannel10() {
        try {
            LineData data1 = mChart2.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch10Yaxis), 0);
                data1.notifyDataChanged();
                mChart2.notifyDataSetChanged();
                mChart2.setVisibleXRangeMaximum(100);
                mChart2.moveViewToX(data1.getEntryCount());
    ...
    private void EntryZaxisChannel10() {
        try {
            LineData data1 = mChart3.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch10Zaxis), 0);
                data1.notifyDataChanged();
                mChart3.notifyDataSetChanged();
                mChart3.setVisibleXRangeMaximum(100);
                mChart3.moveViewToX(data1.getEntryCount());
    ...
    //Channel11
    private void EntryXaxisChannel11() {
        try {
            LineData data1 = mChart1.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch11Xaxis), 0);
                data1.notifyDataChanged();
                mChart1.notifyDataSetChanged();
                mChart1.setVisibleXRangeMaximum(100);
                mChart1.moveViewToX(data1.getEntryCount());
    ...
    private void EntryYaxisChannel11() {
        try {
            LineData data1 = mChart2.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch11Yaxis), 0);
                data1.notifyDataChanged();
                mChart2.notifyDataSetChanged();
                mChart2.setVisibleXRangeMaximum(100);
                mChart2.moveViewToX(data1.getEntryCount());
    ...
    private void EntryZaxisChannel11() {
        try {
            LineData data1 = mChart3.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch11Zaxis), 0);
                data1.notifyDataChanged();
                mChart3.notifyDataSetChanged();
                mChart3.setVisibleXRangeMaximum(100);
                mChart3.moveViewToX(data1.getEntryCount());
    ...
    //Channel12
    private void EntryXaxisChannel12() {
        try {
            LineData data1 = mChart1.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch12Xaxis), 0);
                data1.notifyDataChanged();
                mChart1.notifyDataSetChanged();
                mChart1.setVisibleXRangeMaximum(100);
                mChart1.moveViewToX(data1.getEntryCount());
    ...
    private void EntryYaxisChannel12() {
        try {
            LineData data1 = mChart2.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch12Yaxis), 0);
                data1.notifyDataChanged();
                mChart2.notifyDataSetChanged();
                mChart2.setVisibleXRangeMaximum(100);
                mChart2.moveViewToX(data1.getEntryCount());
    ...
    private void EntryZaxisChannel12() {
        try {
            LineData data1 = mChart3.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch12Zaxis), 0);
                data1.notifyDataChanged();
                mChart3.notifyDataSetChanged();
                mChart3.setVisibleXRangeMaximum(100);
                mChart3.moveViewToX(data1.getEntryCount());
    ...
    //Channel13
    private void EntryXaxisChannel13() {
        try {
            LineData data1 = mChart1.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch13Xaxis), 0);
                data1.notifyDataChanged();
                mChart1.notifyDataSetChanged();
                mChart1.setVisibleXRangeMaximum(100);
                mChart1.moveViewToX(data1.getEntryCount());
    ...
    private void EntryYaxisChannel13() {
        try {
            LineData data1 = mChart2.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch13Yaxis), 0);
                data1.notifyDataChanged();
                mChart2.notifyDataSetChanged();
                mChart2.setVisibleXRangeMaximum(100);
                mChart2.moveViewToX(data1.getEntryCount());
    ...
    private void EntryZaxisChannel13() {
        try {
            LineData data1 = mChart3.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch13Zaxis), 0);
                data1.notifyDataChanged();
                mChart3.notifyDataSetChanged();
                mChart3.setVisibleXRangeMaximum(100);
                mChart3.moveViewToX(data1.getEntryCount());
    ...
    //Channel14
    private void EntryXaxisChannel14() {
        try {
            LineData data1 = mChart1.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch14Xaxis), 0);
                data1.notifyDataChanged();
                mChart1.notifyDataSetChanged();
                mChart1.setVisibleXRangeMaximum(100);
                mChart1.moveViewToX(data1.getEntryCount());
    ...
    private void EntryYaxisChannel14() {
        try {
            LineData data1 = mChart2.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch14Yaxis), 0);
                data1.notifyDataChanged();
                mChart2.notifyDataSetChanged();
                mChart2.setVisibleXRangeMaximum(100);
                mChart2.moveViewToX(data1.getEntryCount());
    ...
    private void EntryZaxisChannel14() {
        try {
            LineData data1 = mChart3.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch14Zaxis), 0);
                data1.notifyDataChanged();
                mChart3.notifyDataSetChanged();
                mChart3.setVisibleXRangeMaximum(100);
                mChart3.moveViewToX(data1.getEntryCount());
    ...
    //Channel15
    private void EntryXaxisChannel15() {
        try {
            LineData data1 = mChart1.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch15Xaxis), 0);
                data1.notifyDataChanged();
                mChart1.notifyDataSetChanged();
                mChart1.setVisibleXRangeMaximum(100);
                mChart1.moveViewToX(data1.getEntryCount());
    ...
    private void EntryYaxisChannel15() {
        try {
            LineData data1 = mChart2.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch15Yaxis), 0);
                data1.notifyDataChanged();
                mChart2.notifyDataSetChanged();
                mChart2.setVisibleXRangeMaximum(100);
                mChart2.moveViewToX(data1.getEntryCount());
    ...
    private void EntryZaxisChannel15() {
        try {
            LineData data1 = mChart3.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch15Zaxis), 0);
                data1.notifyDataChanged();
                mChart3.notifyDataSetChanged();
                mChart3.setVisibleXRangeMaximum(100);
                mChart3.moveViewToX(data1.getEntryCount());
    ...
    //Channel16
    private void EntryXaxisChannel16() {
        try {
            LineData data1 = mChart1.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch16Xaxis), 0);
                data1.notifyDataChanged();
                mChart1.notifyDataSetChanged();
                mChart1.setVisibleXRangeMaximum(100);
                mChart1.moveViewToX(data1.getEntryCount());
    ...
    private void EntryYaxisChannel16() {
        try {
            LineData data1 = mChart2.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch16Yaxis), 0);
                data1.notifyDataChanged();
                mChart2.notifyDataSetChanged();
                mChart2.setVisibleXRangeMaximum(100);
                mChart2.moveViewToX(data1.getEntryCount());
    ...
    private void EntryZaxisChannel16() {
        try {
            LineData data1 = mChart3.getData();
            if (data1 != null) {
                ILineDataSet set1 = data1.getDataSetByIndex(0);
                ...
                data1.addEntry(new Entry(set1.getEntryCount(), ch16Zaxis), 0);
                data1.notifyDataChanged();
                mChart3.notifyDataSetChanged();
                mChart3.setVisibleXRangeMaximum(100);
                mChart3.moveViewToX(data1.getEntryCount());
    ...
    //Creating a Linedataset for Channel colors
    ...
    //Service for serial Port Connection
    @Override
    ...
    private void receive(byte[] data) {
        try {
            if (hexEnabled) {
                ...
                //Storing channels data in array
                //Each channel have 3data's
